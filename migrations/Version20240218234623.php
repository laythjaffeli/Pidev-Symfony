 ...
 */
final class Version20240218234623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(10000) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, INDEX IDX_B8755515BCF5E72D (categorie_id), INDEX IDX_B8755515FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, total DOUBLE PRECISION NOT NULL, mode_paiement VARCHAR(255) NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, date_livraison DATE NOT NULL, INDEX IDX_6EEAA67DFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, etablissement_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, message VARCHAR(255) NOT NULL, note VARCHAR(255) NOT NULL, INDEX IDX_67F068BCFF631228 (etablissement_id), INDEX IDX_67F068BCFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etablissement (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, INDEX IDX_20FD592CFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, etablissement_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, type_id INT DEFAULT NULL, activite_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(900) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, condition_utilisation VARCHAR(255) NOT NULL, INDEX IDX_AF86866FFF631228 (etablissement_id), INDEX IDX_AF86866FF347EFB (produit_id), INDEX IDX_AF86866FC54C8C93 (type_id), INDEX IDX_AF86866F9B0F88B1 (activite_id), INDEX IDX_AF86866FFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, categorie VARCHAR(255) NOT NULL, description VARCHAR(10000) NOT NULL, INDEX IDX_29A5EC27FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclammation (id INT AUTO_INCREMENT NOT NULL, reponse_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, description VARCHAR(10000) NOT NULL, titre VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, statut VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1F8C1D97CF18BB82 (reponse_id), INDEX IDX_1F8C1D97FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, reponse_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3CF18BB82 (reponse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE etablissement ADD CONSTRAINT FK_20FD592CFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE offre ADD CONSTRAINT FK_AF86866FFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD CONSTRAINT FK_1D1C63B3CF18BB82 FOREIGN KEY (reponse_id) REFERENCES reponse (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etablissement DROP FOREIGN KEY FK_20FD592CFB88E14F');
        ...
        $this->addSql('ALTER TABLE utilisateur DROP FOREIGN KEY FK_1D1C63B3CF18BB82');
