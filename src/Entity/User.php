...
#[ORM\Table(name: '`user`')]
#[UniqueEntity(fields: ['email'], message: 'Compte déja existant avec cet email')]
...
class User implements UserInterface
{
    ...
    #[Assert\GreaterThanOrEqual(value: 0, message: 'Numéro du CIN ne peut pas être négatif.')]
    ...
    #[Assert\Length(
        min: 2,
        max: 50,
        minMessage: 'Il faut inserer au moins 2 characteres',
        maxMessage: 'Il faut inserer au maximum 50 characteres',
    )]
    #[Assert\Type(
        type:"string",
        message:"veuillez inserer un nom valide "
    )]
    ...
    #[Assert\Length(max: 50, maxMessage: 'L\'adresse ne peut pas dépasser 50 caractères.')]
    ...
    #[Assert\GreaterThanOrEqual(value: 0, message: 'Le numéro de télephone ne peut pas être négatif.')]
